...
const Home = () => (
  <div className="pt-20 flex flex-col justify-center items-center gap-y-6 text-center">
    <h1 className="md:text-8xl text-5xl max-w-4xl uppercase font-bold bg-clip-text text-transparent bg-gradient-to-r from-amber-500 to-red-400">
      Helsinki City Bike App
    </h1>
    <p className="w-3/5 pt-10 md:text-xl text-lg text-gray-600">
